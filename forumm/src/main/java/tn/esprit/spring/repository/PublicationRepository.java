...
public interface PublicationRepository extends JpaRepository<Publication ,Long>  {
	...
	@Query(value = "select new tn.esprit.spring.entity.CountType(COUNT (*)/(Select COUNT(*) from Publication) * 100, typepublication) from Publication GROUP By typepublication") 
