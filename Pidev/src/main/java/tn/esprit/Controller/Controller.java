...
@ResponseBody
public void DeleteTravelById(@RequestBody Travel t) {
	serviceIMPL.DeleteTravelById(t);
}
@GetMapping("/ShowAll")
@ResponseBody
public List<Travel> DisplayAll(@RequestBody Travel t) {
	return serviceIMPL.DisplayAll(t);
}
